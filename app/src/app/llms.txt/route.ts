...
Продуктът поддържа номерация по редици без пропуски, ДДС по ЗДДС включително основанието ${DEFAULT_EXEMPTION_GROUND} за нерегистрирани издатели, суми в евро, PDF с кирилица и изпращане по имейл.
