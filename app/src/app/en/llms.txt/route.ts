...
The product supports gap-free sequential numbering and VAT by country, including local rates, exemptions and cross-border reverse charge with a VIES check. For Germany, France, Italy, Poland and Romania it also generates the national e-invoice XML (XRechnung, Chorus Pro, FatturaPA, KSeF FA(3), RO CIUS-RO), ready to upload to the national platform; Bulgaria and any other country get a generic EN 16931 UBL file, plus a PDF in the country's language sent by email.
